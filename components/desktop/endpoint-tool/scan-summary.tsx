...
export function ScanSummary() {
  ...
  return (
    <div
      className="px-4 py-3 border-t border-[hsl(170,20%,15%)] shrink-0"
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-1.5 text-center">
        <div className="bg-[hsla(0,72%,51%,0.1)] border border-[hsla(0,72%,51%,0.15)] rounded-md px-1 py-1.5">
        ...
        <div className="bg-[hsla(30,100%,50%,0.08)] border border-[hsla(30,100%,50%,0.12)] rounded-md px-1 py-1.5">
        ...
        <div className="bg-[hsla(45,100%,50%,0.06)] border border-[hsla(45,100%,50%,0.10)] rounded-md px-1 py-1.5">
